...
export const TRANSCRIPTION_SERVICES = [
			...
			]),
	{
		...
		description: 'NVIDIA NeMo 模型,用于快速本地转录',
		...
		: [
				{
					...
					icon: moonshineIcon,
					invertInDarkMode: false,
					description: '由 UsefulSensors 开发的高效 ONNX 模型',
